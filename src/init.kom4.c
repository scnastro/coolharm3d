...
void init_base(void)
{
	...
	GridLength[2] = 2. ;        /* Length of X2 dimension */ 
	GridLength[3] = 2. ;        /* Length of X3 dimension */ 
	...
	startx[1] = -0.75;               /* Set the Physical Minimum boundary  */
	startx[2] = -0.75;               /* Set the Physical Minimum boundary  */
	startx[3] = -0.75;               /* Set the Physical Minimum boundary  */
