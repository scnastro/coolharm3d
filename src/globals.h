...
extern double *radfunc_Te_eV;  /* output gridfunction, electron temperature in eV */
#endif
...
extern int  n1_photo, n3_photo, n_photo, n_data_photo; /* photosphere global array lengths  */
extern double *xp1_photo, *xp3_photo, *r_photo, *ph_photo, *dA_photo, *final_data_photo;  /* photosphere global arrays */
...
#if( USE_COOLING_FUNCTION == 5 )
extern void  setup_corona_cooling2( double ****prim, double Dt);
#endif
