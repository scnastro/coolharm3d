...
//  }
  ...
  vcon[0] = gcon[0][0]*vcov[0] 
          + gcon[0][1]*vcov[1] 
          + gcon[0][2]*vcov[2] 
          + gcon[0][3]*vcov[3] ;
  vcon[1] = gcon[1][0]*vcov[0] 
          + gcon[1][1]*vcov[1] 
          + gcon[1][2]*vcov[2] 
          + gcon[1][3]*vcov[3] ;
  vcon[2] = gcon[2][0]*vcov[0] 
          + gcon[2][1]*vcov[1] 
          + gcon[2][2]*vcov[2] 
          + gcon[2][3]*vcov[3] ;
  vcon[3] = gcon[3][0]*vcov[0] 
          + gcon[3][1]*vcov[1] 
          + gcon[3][2]*vcov[2] 
          + gcon[3][3]*vcov[3] ;
...
//  }
  ...
  vcov[0] = gcov[0][0]*vcon[0] 
          + gcov[0][1]*vcon[1] 
          + gcov[0][2]*vcon[2] 
          + gcov[0][3]*vcon[3] ;
  vcov[1] = gcov[1][0]*vcon[0] 
          + gcov[1][1]*vcon[1] 
          + gcov[1][2]*vcon[2] 
          + gcov[1][3]*vcon[3] ;
  vcov[2] = gcov[2][0]*vcon[0] 
          + gcov[2][1]*vcon[1] 
          + gcov[2][2]*vcon[2] 
          + gcov[2][3]*vcon[3] ;
  vcov[3] = gcov[3][0]*vcon[0] 
          + gcov[3][1]*vcon[1] 
          + gcov[3][2]*vcon[2] 
          + gcov[3][3]*vcon[3] ;
