...
Relativistic Rotor test (Del Zanna, Bucciantini, Londrillo 2003)
Run with 400x400 points.
***********************************************************************************/
...
void init_base(void)
{
	...
	startx[1] =  -0.5;               /* Set the Physical Minimum boundary  */
	startx[2] =  -0.5;               /* Set the Physical Minimum boundary  */
	...
	DT_out[OUT_SDF]     = GridLength[0]/40. ;	/* sdf frequency */
...
void init_data(void) 
{
  ...
  double ut, uphi, omega, ux, uy, r_0, vrot;
