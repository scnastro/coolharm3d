...
FTYPE Bsq,QdotBsq,Qtsq,Qdotn,D, Sc, rho_gm1,alpha,two_Bsq;
FTYPE W_for_gnr2, rho_for_gnr2, W_for_gnr2_old, rho_for_gnr2_old, drho_dW;
FTYPE g_o_gm1,gm1,gm1_inv;
FTYPE t2,t4,t7,t24,t300,t400;
FTYPE s100,s200;


// Declarations: 
static int Utoprim_new_body(FTYPE U[], struct of_geom *geom, FTYPE prim[], FTYPE *gamma);
static void func_W(FTYPE x[], FTYPE dx[], FTYPE resid[], 
...
int Utoprim_1d_ee(FTYPE U[NPR], FTYPE S, struct of_geom *geom, FTYPE prim[NPR], FTYPE *gamma )
{
...
static int Utoprim_new_body(FTYPE U[NPR], struct of_geom *geom, FTYPE prim[NPR], FTYPE *gamma_out)
{
  ...
  FTYPE x_1d[1],x_rho[1],rho_g;
  FTYPE QdotB,Bcon[NDIM],Qcov[NDIM],Qcon[NDIM],ncov[NDIM],ncon[NDIM],Qsq,Qtcon[NDIM];
  FTYPE rho0,u,p,w,gammasq,gamma,gamma_sq,W_last,W,utsq;
...
{
  int retval, ntries;
  FTYPE  W, x_rho[1], rho, rho_g ;
  FTYPE  t15,   t200,t1000 ;
