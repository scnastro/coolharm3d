...
void init_data(void) 
{
  ...
  if( (METRIC_TYPE_CHOICE != METRIC_KS_SPHERICAL) && (METRIC_DYNAMIC_TYPE_CHOICE != METRIC_DYNAMIC_KS_SPHERICAL)) { 
...
//    rpmax    = 25.;     /* Radius of the pressure maximum ?? */
    ...
    q        = 1.581400;    /* exponent in definition of Omega  */
